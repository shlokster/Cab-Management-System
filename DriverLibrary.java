	...
	private void reWritefile(String modifier) {
		...
		try {
			if (modifier.equals("changeloc")) {
				...
				csvWriter.append(Drivers[driverCount - 1].getDriverID() + "," + Drivers[driverCount - 1].getName() + ","
						+ Drivers[driverCount - 1].getLocation() + "," + Drivers[driverCount - 1].getCarType() + ","
						+ Drivers[driverCount - 1].getNumber() + "," + Drivers[driverCount - 1].getAge() + ","
						+ Drivers[driverCount - 1].getCabID() + "," + Drivers[driverCount - 1].getGender() + ","
						+ Drivers[driverCount - 1].getRating() + "\n");
				csvWriter.flush();
				csvWriter.close();
			} else {
